...
public class FirebaseInit {
    ...
    public FirebaseInit() {
        ...
        String serviceAccountKeyFilePath = "src/main/resources/lead.json"; // Make sure this path is correct
        ...
        try {
            ...
            FirebaseOptions options = FirebaseOptions.builder()
                    ...
                    .setDatabaseUrl("https://villabooking-68377-default-rtdb.firebaseio.com/") // Ensure this is the correct URL for your Realtime Database
                    .build();
